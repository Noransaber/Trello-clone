...
const NavItem: React.FC<NavItemProps> = ({ isActive, isExpanded, organization, onExpand }) => {
            ...
            <AccordionItem
                ...
                <AccordionTrigger
                    ...
                    <div className="flex items-center gap-x-2">
                        ...
                        <span className="font-medium tex-sm">
                            { organization.name }
                        </span>
                    </div>
                </AccordionTrigger>
                ...
                <AccordionContent
                    ...
                    {routes.map((route) => (
                        <Button
                            ...
                            size="sm"
                            variant="ghost"
                            className={cn("w-full pl-10 mb-1  justify-start text-sm font-normal",
